...
const destPath = path.resolve(__dirname, "../wwwroot/"); // "./build/"); // ('../Api/wwwroot')
    ...
    plugins: [
      ...
      new webpack.DefinePlugin({
        ...
        "process.env": {
          ...
          BASE_URL: '"/"',
          // WARN: versioning via package.json disables/destroyes cache in GitActions
          // UI_VERSION: JSON.stringify(require("./package.json").version),
          UI_VERSION: JSON.stringify(
            // eslint-disable-next-line global-require
            (require("fs").readFileSync("./appVersion.txt", "utf-8").match(/(^.*)/) || [])[1] ||
              "Create appVersion.txt with line '1.0.0'"
          ),
        },
      ...
      new CleanPlugin.CleanWebpackPlugin({
        // cleanOnceBeforeBuildPatterns: ["**/*", "!emailTemplates/**/*"],
      }), // it cleans output folder before extracting files
